...
|_____(UNDO)precompute_features.py # Cache the averaged descriptor for 3D points
...
|_____add variance to the 3D descritors, will consider later on how to conduct
